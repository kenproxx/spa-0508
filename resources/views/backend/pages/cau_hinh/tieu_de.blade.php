            ...
            <form action="{{ route('backend.cau-hinh.store') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="mo_ta_web" name="mo_ta_web" placeholder="Nhập mô tả web"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label for="script_code">Mã script</label>
                        <textarea type="text" class="form-control" id="script_code" name="script_code" placeholder="Nhập mã script"></textarea>
                    </div>
                </div>
